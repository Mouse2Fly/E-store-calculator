    ...
    <div class="calculator">
        ...
        <div class="section" id="section-3">
            ...
            <select class="dropdown" id="poleLengthSelect">
                <option value=""></option>
                <option value="68mm" data-type="u-tipo" style="display:none;">68mm</option>
                <option value="71mm" data-type="u-tipo">71mm</option>
                <option value="76mm" data-type="u-tipo" style="display:none;">76mm</option>
                <option value="81mm" data-type="u-tipo">81mm</option>
                <option value="89mm" data-type="u-tipo" style="display:none;">89mm</option>
