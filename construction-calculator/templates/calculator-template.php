    ...
    <div class="calculator">
        ...
        <div class="section">
            <div class="section-header">
                ...
                <h2>ARE YOU INSTALLING THIS PROJECT YOURSELF, OR WOULD YOU LIKE US TO?</h2>
            </div>
            <div class="button-group">
                <button class="option-btn active" data-option="diy">DIY SELF<br>INSTALLATION</button>
                <button class="option-btn" data-option="trade">TRADE SELF<br>INSTALLATION</button>
                <button class="option-btn" data-option="ground">GROUND SCREW<br>CENTRE INSTALLATION</button>
            </div>
            ...
            <div class="section-header">
                ...
                <h2>CHOOSE YOUR STRUCTURE TYPE</h2>
            </div>
            ...
            <div class="section-header">
                ...
                <h2>CHOOSE YOUR BASE TYPE</h2>
            </div>
            <div class="button-group">
                <button class="option-btn active" data-option="joist">JOIST</button>
                <button class="option-btn" data-option="sips">SIPS</button>
            </div>
        ...
        <div class="section">
            ...
            <div class="section-header">
                ...
                <h2>WILL THERE BE ANY ADDITIONAL LOADS?</h2>
            </div>
            <p class="description">E.g. Hot tubs, pool table, bi-fold doors and gym equipment etc.</p>
            <select class="dropdown">
                <option value="">PLEASE SELECT</option>
        ...
        <div class="section">
            ...
            <div class="tool-grid">
                <button class="tool-btn" data-tool="none">NO INSTALLATION TOOL REQUIRED</button>
                <button class="tool-btn active" data-tool="manual">PURCHASE - MANUAL INSTALLATION TOOL</button>
                <button class="tool-btn" data-tool="professional">PURCHASE - PROFESSIONAL RATCHET INSTALLATION TOOL</button>
                <button class="tool-btn" data-tool="hire">HIRE - PROFESSIONAL RATCHET INSTALLATION TOOL</button>
            </div>
        </div>
